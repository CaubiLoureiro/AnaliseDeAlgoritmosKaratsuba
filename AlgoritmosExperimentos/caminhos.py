...
caminhok5 = os.path.abspath('ExperimentoCoefDiferentes/karatsubaCoefGrande')
caminhok6 = os.path.abspath('ExperimentoCoefDiferentes/karatsubaCoefPequeno')
...
caminhod5 = os.path.abspath('ExperimentoCoefDiferentes/mult_diretaCoefPequeno')
caminhod6 = os.path.abspath('ExperimentoCoefDiferentes/mult_diretaCoefGrande')
